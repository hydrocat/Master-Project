...
\subsection{MariaDB}
\todo{+ plz}
A open-source drop-in replacement of MySQL \gls{RDBMS}~\cite{mariadb} that started soon after Oracle purchased Sun Microsystems~\cite{mariadbfuture}. Developed by the original developers of MySQL it is under active development and has large community~\cite{mariadbgit}.
